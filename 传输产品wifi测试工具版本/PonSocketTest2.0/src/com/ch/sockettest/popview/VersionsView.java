...
public class VersionsView extends AbsPopWindow {
	...
	public VersionsView(Display display, int style) {
		...
		lblNewLabel.setText("\u4F20\u8F93\u4EA7\u54C1WIFI \u6D4B\u8BD5\u5DE5\u5177");

		Label lblV = new Label(composite, SWT.NONE);
		lblV.setBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_HIGHLIGHT_SHADOW));
		...
		lblV.setText("\u7248\u672C\uFF1A V 2.0");
		new Label(composite, SWT.NONE);
		new Label(composite, SWT.NONE);

		Label lblc = new Label(composite, SWT.NONE);
		lblc.setBackground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_HIGHLIGHT_SHADOW));
