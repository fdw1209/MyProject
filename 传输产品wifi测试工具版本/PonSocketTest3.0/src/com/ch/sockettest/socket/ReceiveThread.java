	...
	public void run() {
		try {
			...
			if (devName.equals("Dev1")) {
				socket.bind(new InetSocketAddress(MainView.getProp().getProperty("Dev1_CableIp"), 0));
				socket.setReuseAddress(true);
				socket.connect(new InetSocketAddress(MainView.getProp().getProperty("Dev1_WirelessIp"), 8877), 5000);
			}else {
				socket.bind(new InetSocketAddress(MainView.getProp().getProperty("Dev2_CableIp"), 0));
				socket.setReuseAddress(true);
				socket.connect(new InetSocketAddress(MainView.getProp().getProperty("Dev2_WirelessIp"), 9988), 5000);
			}
