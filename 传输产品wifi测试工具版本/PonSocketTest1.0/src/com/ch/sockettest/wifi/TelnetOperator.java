...
public class TelnetOperator {
	...
	public void login(String ip, int port, String username, String password) {
		try {
			...
			if (rs != null && (rs.contains("User name is incorrect") || rs.contains("Password is incorrect")
				...
				throw new RuntimeException("Telnet登录失败");
			}
		} catch (Exception e) {
			throw new RuntimeException("Telnet登录失败");
		}
	...
	public static void main(String[] args) {
		...
		telnet.login("192.168.1.1", 23, "CMCCAdmin", "aDm8H%MdA");
		...
		// String rs = telnet.sendCommand("sismac 2 1280");//Password1 =
		// 6nvsnett
		// String rs = telnet.sendCommand("sismac 2 1028");//SSID2 =
		// CMCC-FxFh-5G
