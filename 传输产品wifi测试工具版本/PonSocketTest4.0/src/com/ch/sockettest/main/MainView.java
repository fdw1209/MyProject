...
public class MainView extends AbsPopWindow {
	...
	private CompDev1TestTable comp1;
	private CompDev2TestTable comp2;
	...
	private void createControl() {
		...
		// 设备1数据列表
		comp1 = new CompDev1TestTable(composite1, SWT.NONE);
		...
		// 设备2数据列表
		comp2 = new CompDev2TestTable(composite1, SWT.NONE);
